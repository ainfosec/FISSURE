...
class TSI_Component: 
    ...
    def startTSI_Detector(self, detector, variable_names, variable_values):
        ...
        if detector in ["wideband_x310.py","wideband_b210.py","wideband_hackrf.py","wideband_b205mini.py","wideband_rtl2832u.py","wideband_limesdr.py","wideband_bladerf.py","wideband_plutosdr.py","wideband_usrp2.py","wideband_usrp_n2xx","Simulator","IQ File"]:
