...
rime_connection::rime_connection(rime_stack* block,
                                 uint16_t channel,
                                 pmt::pmt_t inport,
                                 pmt::pmt_t outport,
...
uint16_t rime_connection::channel() const { return d_channel; }

std::string rime_connection::msg_to_string(pmt::pmt_t msg)
{
    if (pmt::is_pair(msg)) {
