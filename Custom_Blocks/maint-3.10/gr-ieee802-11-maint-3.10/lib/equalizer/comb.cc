                    ...
                    std::shared_ptr<gr::digital::constellation> mod)
{
    ...
    for (int i = 0; i < 64; i++) {
        ...
        if (i <= 11) {
            ...
            H = gr_complex((25 - i) / 14.0, 0) * pilot[0] +
                gr_complex((i - 11) / 14.0, 0) * pilot[1];
        } else if (i <= 39) {
            H = gr_complex((39 - i) / 14.0, 0) * pilot[1] +
                gr_complex((i - 25) / 14.0, 0) * pilot[2];
        } else if (i <= 53) {
            H = gr_complex((53 - i) / 14.0, 0) * pilot[2] +
                gr_complex((i - 39) / 14.0, 0) * pilot[3];
        } else {
