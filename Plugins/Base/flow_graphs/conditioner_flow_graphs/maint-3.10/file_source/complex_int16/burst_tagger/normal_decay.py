...
class normal_decay(gr.top_block):
    ...
    def __init__(self, decay='.0002', filepath="/home/user/Conditioner/Data/tpms/four_tires2.iq", sample_rate='1e6', threshold='5000'):
        ...
        self.blocks_delay_1 = blocks.delay(gr.sizeof_gr_complex*1, 20000)
...
def argument_parser():
    ...
    parser.add_argument(
        "--threshold", dest="threshold", type=str, default='5000',
        help="Set 5000 [default=%(default)r]")
    return parser
