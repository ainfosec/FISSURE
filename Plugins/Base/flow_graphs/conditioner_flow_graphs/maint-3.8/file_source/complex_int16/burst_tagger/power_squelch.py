...
class power_squelch(gr.top_block):
    ...
    def __init__(self, filepath="/home/user/CLANKER/Data/tpms/four_tires2.iq", sample_rate='1e6', squelch='-70', threshold='.002'):
        ...
        # Connections
        ##################################################
        self.connect((self.analog_pwr_squelch_xx_0, 0), (self.blocks_complex_to_mag_squared_0_0, 0))
        self.connect((self.analog_pwr_squelch_xx_0, 0), (self.blocks_delay_1, 0))
...
def argument_parser():
    ...
    parser.add_argument(
        "--filepath", dest="filepath", type=str, default="/home/user/CLANKER/Data/tpms/four_tires2.iq",
        help="Set /home/user/CLANKER/Data/tpms/four_tires2.iq [default=%(default)r]")
    parser.add_argument(
