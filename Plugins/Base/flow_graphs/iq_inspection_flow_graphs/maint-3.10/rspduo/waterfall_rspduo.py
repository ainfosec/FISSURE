...
class waterfall_rspduo(gr.top_block, Qt.QWidget):

    def __init__(self, serial='0'):
        gr.top_block.__init__(self, "Waterfall Rspduo", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Waterfall Rspduo")
        ...
        self.settings = Qt.QSettings("GNU Radio", "waterfall_rspduo")
        ...
        self.sdrplay3_rspduo_0.set_center_freq((float(sample_rate)*1e6), False)
        ...
        # Connections
        ##################################################
        self.connect((self.sdrplay3_rspduo_0, 0), (self.qtgui_waterfall_sink_x_0, 0))
    ...
    def set_sample_rate(self, sample_rate):
        ...
        self.sdrplay3_rspduo_0.set_center_freq((float(self.sample_rate)*1e6), False)
...
def main(top_block_cls=waterfall_rspduo, options=None):
    if options is None:
