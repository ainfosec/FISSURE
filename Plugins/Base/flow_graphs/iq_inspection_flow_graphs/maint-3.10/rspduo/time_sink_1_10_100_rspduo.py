...
# Title: Time Sink 1 10 100 Rspduo
...
class time_sink_1_10_100_rspduo(gr.top_block, Qt.QWidget):

    def __init__(self, serial='0'):
        gr.top_block.__init__(self, "Time Sink 1 10 100 Rspduo", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Time Sink 1 10 100 Rspduo")
        ...
        self.settings = Qt.QSettings("GNU Radio", "time_sink_1_10_100_rspduo")
        ...
        self.sdrplay3_rspduo_0.set_center_freq((float(rx_frequency)*1e6), False)
        ...
        self.connect((self.sdrplay3_rspduo_0, 0), (self.blocks_keep_one_in_n_0, 0))
        self.connect((self.sdrplay3_rspduo_0, 0), (self.blocks_keep_one_in_n_0_0, 0))
        self.connect((self.sdrplay3_rspduo_0, 0), (self.qtgui_time_sink_x_0, 0))
    ...
    def set_rx_frequency(self, rx_frequency):
        ...
        self.sdrplay3_rspduo_0.set_center_freq((float(self.rx_frequency)*1e6), False)
...
def main(top_block_cls=time_sink_1_10_100_rspduo, options=None):
    if options is None:
