...
class time_sink_rspduo(gr.top_block, Qt.QWidget):

    def __init__(self, serial='0'):
        gr.top_block.__init__(self, "Time Sink Rspduo", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Time Sink Rspduo")
        ...
        self.settings = Qt.QSettings("GNU Radio", "time_sink_rspduo")
...
def main(top_block_cls=time_sink_rspduo, options=None):
    if options is None:
