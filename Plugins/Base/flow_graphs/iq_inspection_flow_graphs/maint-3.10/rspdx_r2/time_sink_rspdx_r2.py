...
class time_sink_rspdx_r2(gr.top_block, Qt.QWidget):

    def __init__(self, serial='0'):
        gr.top_block.__init__(self, "Time Sink Rspdx R2", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Time Sink Rspdx R2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "time_sink_rspdx_r2")
...
def main(top_block_cls=time_sink_rspdx_r2, options=None):
    if options is None:
