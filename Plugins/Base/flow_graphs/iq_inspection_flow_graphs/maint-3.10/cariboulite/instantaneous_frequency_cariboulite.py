...
# Title: Instantaneous Frequency Cariboulite
...
class instantaneous_frequency_cariboulite(gr.top_block, Qt.QWidget):

    def __init__(self, serial="0"):
        gr.top_block.__init__(self, "Instantaneous Frequency Cariboulite", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Instantaneous Frequency Cariboulite")
        ...
        self.settings = Qt.QSettings("GNU Radio", "instantaneous_frequency_cariboulite")
...
def main(top_block_cls=instantaneous_frequency_cariboulite, options=None):
    if options is None:
