...
class time_sink_cariboulite(gr.top_block, Qt.QWidget):

    def __init__(self, serial="0"):
        gr.top_block.__init__(self, "Time Sink Cariboulite", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Time Sink Cariboulite")
        ...
        self.settings = Qt.QSettings("GNU Radio", "time_sink_cariboulite")
...
def main(top_block_cls=time_sink_cariboulite, options=None):
    if options is None:
