...
class waterfall_cariboulite(gr.top_block, Qt.QWidget):

    def __init__(self, serial="0"):
        gr.top_block.__init__(self, "Waterfall Cariboulite", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Waterfall Cariboulite")
        ...
        self.settings = Qt.QSettings("GNU Radio", "waterfall_cariboulite")
...
def main(top_block_cls=waterfall_cariboulite, options=None):
    if options is None:
