...
# Title: Time Sink 1 10 100 Cariboulite
...
class time_sink_1_10_100_cariboulite(gr.top_block, Qt.QWidget):

    def __init__(self, serial="0"):
        gr.top_block.__init__(self, "Time Sink 1 10 100 Cariboulite", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Time Sink 1 10 100 Cariboulite")
        ...
        self.settings = Qt.QSettings("GNU Radio", "time_sink_1_10_100_cariboulite")
        ...
        self._rx_gain_range = qtgui.Range(-1, 60, 1, 50, 200)
        ...
        for c in range(0, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._rx_frequency_range = qtgui.Range(70, 6000, .1, 2412, 200)
        self._rx_frequency_win = qtgui.RangeWidget(self._rx_frequency_range, self.set_rx_frequency, " Freq. (MHz):", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.soapy_custom_source_0.set_frequency(0, (float(rx_frequency)*1e6))
        ...
        self.connect((self.soapy_custom_source_0, 0), (self.blocks_keep_one_in_n_0, 0))
        self.connect((self.soapy_custom_source_0, 0), (self.blocks_keep_one_in_n_0_0, 0))
    ...
    def set_rx_frequency(self, rx_frequency):
        ...
        self.soapy_custom_source_0.set_frequency(0, (float(self.rx_frequency)*1e6))
...
def main(top_block_cls=time_sink_1_10_100_cariboulite, options=None):
    if options is None:
