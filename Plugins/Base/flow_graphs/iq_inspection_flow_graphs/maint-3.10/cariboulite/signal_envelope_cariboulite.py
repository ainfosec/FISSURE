...
# Title: Signal Envelope Cariboulite
...
class signal_envelope_cariboulite(gr.top_block, Qt.QWidget):

    def __init__(self, serial="0"):
        gr.top_block.__init__(self, "Signal Envelope Cariboulite", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Signal Envelope Cariboulite")
        ...
        self.settings = Qt.QSettings("GNU Radio", "signal_envelope_cariboulite")
...
def main(top_block_cls=signal_envelope_cariboulite, options=None):
    if options is None:
