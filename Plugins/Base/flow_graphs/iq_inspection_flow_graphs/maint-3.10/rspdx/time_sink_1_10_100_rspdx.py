...
# Title: Time Sink 1 10 100 Rspdx
...
class time_sink_1_10_100_rspdx(gr.top_block, Qt.QWidget):

    def __init__(self, serial='0'):
        gr.top_block.__init__(self, "Time Sink 1 10 100 Rspdx", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Time Sink 1 10 100 Rspdx")
        ...
        self.settings = Qt.QSettings("GNU Radio", "time_sink_1_10_100_rspdx")
        ...
        self.connect((self.sdrplay3_rspdx_0, 0), (self.blocks_keep_one_in_n_0, 0))
        self.connect((self.sdrplay3_rspdx_0, 0), (self.blocks_keep_one_in_n_0_0, 0))
        self.connect((self.sdrplay3_rspdx_0, 0), (self.qtgui_time_sink_x_0, 0))
...
def main(top_block_cls=time_sink_1_10_100_rspdx, options=None):
    if options is None:
