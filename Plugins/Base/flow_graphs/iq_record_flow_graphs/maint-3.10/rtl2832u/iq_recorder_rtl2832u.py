...
class iq_recorder_rtl2832u(gr.top_block):
    ...
    def __init__(self, file_length="100000", filepath="", rx_frequency="2412", rx_gain="25", sample_rate="2.56", serial=""):
        ...
        self.soapy_rtlsdr_source_0 = soapy.source(dev, "fc32", 1, "serial=" + str(serial),
...
def argument_parser():
    ...
    parser.add_argument(
        "--sample-rate", dest="sample_rate", type=str, default="2.56",
