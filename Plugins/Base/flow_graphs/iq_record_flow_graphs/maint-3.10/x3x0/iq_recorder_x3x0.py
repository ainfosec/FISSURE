...
class iq_recorder_x3x0(gr.top_block):

    def __init__(self, file_length="100000", filepath="", ip_address="192.168.40.2", rx_antenna="TX/RX", rx_channel="A:0", rx_frequency="2412", rx_gain="20", sample_rate="1"):
        gr.top_block.__init__(self, "Iq Recorder X3X0", catch_exceptions=True)
...
def main(top_block_cls=iq_recorder_x3x0, options=None):
    if options is None:
