...
class iq_playback_limesdr(gr.top_block):
    ...
    def __init__(self, filepath="", sample_rate="4", serial="", tx_channel="0", tx_frequency="2425.715", tx_gain="30"):
        ...
        # Blocks
        ##################################################
        self.limesdr_sink_0 = limesdr.sink(serial, 0, '', '')


        self.limesdr_sink_0.set_sample_rate(float(sample_rate)*1e6)


        self.limesdr_sink_0.set_center_freq(float(tx_frequency)*1e6, 0)
