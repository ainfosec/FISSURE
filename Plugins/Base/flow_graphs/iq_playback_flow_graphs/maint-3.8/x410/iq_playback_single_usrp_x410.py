...
class iq_playback_single_usrp_x410(gr.top_block):
    ...
    def __init__(self, filepath="", ip_address="192.168.40.2", sample_rate="4", tx_channel="A:0", tx_frequency="2425.715", tx_gain="30"):
        gr.top_block.__init__(self, "Iq Playback Single Usrp X410")
