...
class iq_playback_x3x0(gr.top_block):
    ...
    def __init__(self, filepath="", ip_address="192.168.40.2", sample_rate="4", serial="False", tx_channel="A:0", tx_frequency="2425.715", tx_gain="70"):
        gr.top_block.__init__(self, "Iq Playback X3X0", catch_exceptions=True)
...
def main(top_block_cls=iq_playback_x3x0, options=None):
    if options is None:
