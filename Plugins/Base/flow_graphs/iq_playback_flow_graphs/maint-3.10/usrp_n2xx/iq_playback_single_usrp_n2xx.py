...
# Title: Iq Playback Single Usrp N2Xx
...
class iq_playback_single_usrp_n2xx(gr.top_block):

    def __init__(self, filepath="", ip_address="192.168.10.2", sample_rate="4", tx_channel="A:0", tx_frequency="2425.715", tx_gain="30"):
        gr.top_block.__init__(self, "Iq Playback Single Usrp N2Xx", catch_exceptions=True)
...
def main(top_block_cls=iq_playback_single_usrp_n2xx, options=None):
    if options is None:
