...
# Title: Iq Playback Single Usrp2
...
class iq_playback_single_usrp2(gr.top_block):

    def __init__(self, filepath="", ip_address="192.168.10.2", sample_rate="4", tx_channel="A:0", tx_frequency="2425.715", tx_gain="70"):
        gr.top_block.__init__(self, "Iq Playback Single Usrp2", catch_exceptions=True)
...
def main(top_block_cls=iq_playback_single_usrp2, options=None):
    if options is None:
