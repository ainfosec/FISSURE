...
class iq_playback_hackrf(gr.top_block):

    def __init__(self, filepath="", sample_rate="4", serial="0", tx_frequency="2425.715", tx_gain="70"):
        gr.top_block.__init__(self, "Iq Playback Hackrf", catch_exceptions=True)
...
def main(top_block_cls=iq_playback_hackrf, options=None):
    if options is None:
