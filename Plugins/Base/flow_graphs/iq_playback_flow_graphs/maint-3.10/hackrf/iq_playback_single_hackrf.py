...
# Title: Iq Playback Single Hackrf
...
class iq_playback_single_hackrf(gr.top_block):

    def __init__(self, filepath="", sample_rate="4", serial="0", tx_frequency="2425.715", tx_gain="70"):
        gr.top_block.__init__(self, "Iq Playback Single Hackrf", catch_exceptions=True)
        ...
        self.osmosdr_sink_0.set_bb_gain(float(tx_gain), 0)
    ...
    def set_tx_gain(self, tx_gain):
        self.tx_gain = tx_gain
        self.osmosdr_sink_0.set_bb_gain(float(self.tx_gain), 0)
...
def main(top_block_cls=iq_playback_single_hackrf, options=None):
    if options is None:
