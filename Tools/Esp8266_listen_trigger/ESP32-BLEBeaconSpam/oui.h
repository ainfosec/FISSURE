...
long OUIList[56] = {
  ...
  0x000006,    /* Xerox */
  0x00000C,    /* Cisco (future use) */
  0x00005E,    /* the IANA */
  0x000081,    /* Nortel SONMP */
  0x0000F8,    /* Cisco (IOS 9.0 and above?) */
  0x000142,    /* Cisco */
  0x000143,    /* Cisco */
  0x0001E8,    /* Force10 */
  ...
  0x00120F,    /* IEEE 802.3 */
  0x0012BB,    /* Media (TIA TR-41 Committee) */
  ...
  0x0016B8,    /* Sony Ericsson Mobile Communications AB */
  0x001813,    /* Sony Ericsson Mobile Communications AB */
  0x001958,    /* Bluetooth SIG */
  0x001963,    /* Sony Ericsson Mobile Communications AB */
  0x001977,    /* Airohive AP to AP communication */
  0x001B21,    /* Data Center Bridging Capabilities Exchange Protocol */
  0X001B67,    /* Cisco/Ubiquisys */
  0x001B3F,    /* IEEE 802.1 Qbg */
  0x001F32,
  0x0020F6,    /* KarlNet, who brought you Turbocell */
  0x00400D,    /* Avaya */
  0x004096,    /* Cisco Wireless (Aironet) */
  0x005043,    /* Marvell Semiconductor */
  0x0050F2,    /* Wi-Fi : WPA / WME */
  0x008037,    /* Ericsson Group */
  0x0080C2,    /* IEEE 802.1 Committee */
  0x00904C,    /* Wi-Fi : 802.11 Pre-N */
  0x00A03E,    /* ATM Forum */
  0x00E02B,    /* Extreme EDP/ESRP */
  0x00E02F,    /* DOCSIS spanning tree BPDU */
  0x00E052,    /* Foundry */
  0x080006,    /* Siemens AG */
  0x080007,    /* Appletalk */
  ...
  0xCF0002,    /* 3GPP2 */
  0x000ce6,    /* Meru Network (Fortinet) */
  0x00A0F8     /* Extreme/WING (Zebra) */
};


uint16_t vendorList[1763] = {
