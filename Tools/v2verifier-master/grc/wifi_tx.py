...
# Title: Wifi Tx
# Generated: Fri May 21 22:23:58 2021
##################################################
...
class wifi_tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.ieee802_11_mac_0 = ieee802_11.mac(([0x00, 0x00, 0x00, 0x00, 0x00, 0x00]), ([0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF]), ([0xff, 0xff, 0xff, 0xff, 0xff, 255]))
