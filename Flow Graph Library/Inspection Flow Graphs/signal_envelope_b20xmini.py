...
# Title: Signal Envelope B20Xmini
...
class signal_envelope_b20xmini(gr.top_block, Qt.QWidget):

    def __init__(self, rx_usrp_channel="A:A", serial="False"):
        gr.top_block.__init__(self, "Signal Envelope B20Xmini", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Signal Envelope B20Xmini")
        ...
        self.settings = Qt.QSettings("GNU Radio", "signal_envelope_b20xmini")
...
def main(top_block_cls=signal_envelope_b20xmini, options=None):
    if options is None:
