...
# Title: Time Sink 1 10 100 Rtl2832U
...
class time_sink_1_10_100_rtl2832u(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Time Sink 1 10 100 Rtl2832U")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Time Sink 1 10 100 Rtl2832U")
        ...
        self.settings = Qt.QSettings("GNU Radio", "time_sink_1_10_100_rtl2832u")
        ...
        self._sample_rate_options = [500000.0, 1000000.0, 2000000.0]
        ...
        self.rtlsdr_source_0_0.set_bb_gain(rx_rtl_gain, 0)
    ...
    def set_rx_rtl_gain(self, rx_rtl_gain):
        ...
        self.rtlsdr_source_0_0.set_bb_gain(self.rx_rtl_gain, 0)
...
def main(top_block_cls=time_sink_1_10_100_rtl2832u, options=None):
