...
class waterfall_b20xmini(gr.top_block, Qt.QWidget):

    def __init__(self, rx_usrp_channel="A:A", serial="False"):
        gr.top_block.__init__(self, "Waterfall B20Xmini", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Waterfall B20Xmini")
        ...
        self.settings = Qt.QSettings("GNU Radio", "waterfall_b20xmini")
...
def main(top_block_cls=waterfall_b20xmini, options=None):
    if options is None:
