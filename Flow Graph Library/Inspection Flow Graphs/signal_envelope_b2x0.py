...
class signal_envelope_b2x0(gr.top_block, Qt.QWidget):

    def __init__(self, rx_usrp_channel="A:A", serial="False"):
        gr.top_block.__init__(self, "Signal Envelope B2X0", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Signal Envelope B2X0")
        ...
        self.settings = Qt.QSettings("GNU Radio", "signal_envelope_b2x0")
...
def main(top_block_cls=signal_envelope_b2x0, options=None):
    if options is None:
