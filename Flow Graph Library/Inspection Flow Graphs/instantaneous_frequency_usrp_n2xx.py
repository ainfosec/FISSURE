...
# Title: Instantaneous Frequency Usrp N2Xx
# Generated: Sun Sep 18 22:13:18 2022
##################################################
...
class instantaneous_frequency_usrp_n2xx(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Instantaneous Frequency Usrp N2Xx")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Instantaneous Frequency Usrp N2Xx")
        ...
        self.settings = Qt.QSettings("GNU Radio", "instantaneous_frequency_usrp_n2xx")
...
def main(top_block_cls=instantaneous_frequency_usrp_n2xx, options=None):
