...
# Title: Instantaneous Frequency B205Mini
# Generated: Sat Jan  1 22:15:06 2022
##################################################
...
class instantaneous_frequency_b205mini(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Instantaneous Frequency B205Mini")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Instantaneous Frequency B205Mini")
        ...
        self.settings = Qt.QSettings("GNU Radio", "instantaneous_frequency_b205mini")
...
def main(top_block_cls=instantaneous_frequency_b205mini, options=None):
