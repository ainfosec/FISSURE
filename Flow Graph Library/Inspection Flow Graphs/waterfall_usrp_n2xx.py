...
# Title: Waterfall Usrp N2Xx
# Generated: Sun Sep 18 22:16:32 2022
##################################################
...
class waterfall_usrp_n2xx(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Waterfall Usrp N2Xx")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Waterfall Usrp N2Xx")
        ...
        self.settings = Qt.QSettings("GNU Radio", "waterfall_usrp_n2xx")
...
def main(top_block_cls=waterfall_usrp_n2xx, options=None):
