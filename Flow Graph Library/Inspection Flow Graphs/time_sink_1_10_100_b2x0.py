...
class time_sink_1_10_100_b2x0(gr.top_block, Qt.QWidget):

    def __init__(self, rx_usrp_channel="A:A", serial="False"):
        gr.top_block.__init__(self, "Time Sink 1 10 100 B2X0", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Time Sink 1 10 100 B2X0")
        ...
        self.settings = Qt.QSettings("GNU Radio", "time_sink_1_10_100_b2x0")
...
def main(top_block_cls=time_sink_1_10_100_b2x0, options=None):
    if options is None:
