...
# Title: Signal Envelope Usrp2
# Generated: Sun Sep 18 22:14:15 2022
##################################################
...
class signal_envelope_usrp2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Signal Envelope Usrp2")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Signal Envelope Usrp2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "signal_envelope_usrp2")
...
def main(top_block_cls=signal_envelope_usrp2, options=None):
