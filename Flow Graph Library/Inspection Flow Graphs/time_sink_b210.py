...
class time_sink_b210(gr.top_block, Qt.QWidget):

    def __init__(self, rx_usrp_channel="A:A", serial="False"):
        gr.top_block.__init__(self, "Time Sink B210")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Time Sink B210")
        ...
        self.settings = Qt.QSettings("GNU Radio", "time_sink_b210")
        ...
        self.uhd_usrp_source_0.set_subdev_spec(str(rx_usrp_channel), 0)
...
def main(top_block_cls=time_sink_b210, options=None):
    if options is None:
