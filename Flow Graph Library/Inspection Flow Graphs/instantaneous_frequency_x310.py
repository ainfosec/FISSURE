...
# Title: Instantaneous Frequency X310
# Generated: Thu Sep  3 13:12:08 2020
##################################################
...
class instantaneous_frequency_x310(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Instantaneous Frequency X310")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Instantaneous Frequency X310")
        ...
        self.settings = Qt.QSettings("GNU Radio", "instantaneous_frequency_x310")
...
def main(top_block_cls=instantaneous_frequency_x310, options=None):
