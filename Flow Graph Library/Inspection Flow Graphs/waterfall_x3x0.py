...
class waterfall_x3x0(gr.top_block, Qt.QWidget):

    def __init__(self, ip_address="192.168.140.2", rx_usrp_channel="A:0"):
        gr.top_block.__init__(self, "Waterfall X3X0", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Waterfall X3X0")
        ...
        self.settings = Qt.QSettings("GNU Radio", "waterfall_x3x0")
...
def main(top_block_cls=waterfall_x3x0, options=None):
    if options is None:
