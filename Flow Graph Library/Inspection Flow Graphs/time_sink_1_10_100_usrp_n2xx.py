...
# Title: Time Sink 1 10 100 Usrp N2Xx
# Generated: Sun Sep 18 22:14:49 2022
##################################################
...
class time_sink_1_10_100_usrp_n2xx(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Time Sink 1 10 100 Usrp N2Xx")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Time Sink 1 10 100 Usrp N2Xx")
        ...
        self.settings = Qt.QSettings("GNU Radio", "time_sink_1_10_100_usrp_n2xx")
...
def main(top_block_cls=time_sink_1_10_100_usrp_n2xx, options=None):
