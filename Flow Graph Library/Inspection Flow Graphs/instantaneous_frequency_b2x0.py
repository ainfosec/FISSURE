...
# Title: Instantaneous Frequency B2X0
...
class instantaneous_frequency_b2x0(gr.top_block, Qt.QWidget):

    def __init__(self, rx_usrp_channel="A:A", serial="False"):
        gr.top_block.__init__(self, "Instantaneous Frequency B2X0", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Instantaneous Frequency B2X0")
        ...
        self.settings = Qt.QSettings("GNU Radio", "instantaneous_frequency_b2x0")
        ...
        self._rx_usrp_gain_win = GrRangeWidget(self._rx_usrp_gain_range, self.set_rx_usrp_gain, "              Gain:", "counter_slider", float, QtCore.Qt.Horizontal, "value")
...
def main(top_block_cls=instantaneous_frequency_b2x0, options=None):
    if options is None:
