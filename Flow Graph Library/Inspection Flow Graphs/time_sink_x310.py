...
# Title: Time Sink X310
# Generated: Thu Sep  3 13:12:03 2020
##################################################
...
class time_sink_x310(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Time Sink X310")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Time Sink X310")
        ...
        self.settings = Qt.QSettings("GNU Radio", "time_sink_x310")
...
def main(top_block_cls=time_sink_x310, options=None):
