...
# Generated: Sun Aug 21 14:46:11 2022
##################################################
...
class time_sink_hackrf(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Time Sink Hackrf")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Time Sink Hackrf")
...
def main(top_block_cls=time_sink_hackrf, options=None):
