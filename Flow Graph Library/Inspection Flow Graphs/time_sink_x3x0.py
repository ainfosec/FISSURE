...
class time_sink_x3x0(gr.top_block, Qt.QWidget):

    def __init__(self, ip_address="192.168.140.2", rx_usrp_channel="A:0"):
        gr.top_block.__init__(self, "Time Sink X3X0", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Time Sink X3X0")
        ...
        self.settings = Qt.QSettings("GNU Radio", "time_sink_x3x0")
...
def main(top_block_cls=time_sink_x3x0, options=None):
    if options is None:
