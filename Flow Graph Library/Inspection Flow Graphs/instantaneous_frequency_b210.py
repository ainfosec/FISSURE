...
# Title: Instantaneous Frequency B210
# Generated: Sat Jan  1 22:15:18 2022
##################################################
...
class instantaneous_frequency_b210(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Instantaneous Frequency B210")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Instantaneous Frequency B210")
        ...
        self.settings = Qt.QSettings("GNU Radio", "instantaneous_frequency_b210")
...
def main(top_block_cls=instantaneous_frequency_b210, options=None):
