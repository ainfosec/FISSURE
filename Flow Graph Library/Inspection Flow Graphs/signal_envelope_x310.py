...
# Title: Signal Envelope X310
# Generated: Thu Sep  3 13:12:05 2020
##################################################
...
class signal_envelope_x310(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Signal Envelope X310")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Signal Envelope X310")
        ...
        self.settings = Qt.QSettings("GNU Radio", "signal_envelope_x310")
...
def main(top_block_cls=signal_envelope_x310, options=None):
