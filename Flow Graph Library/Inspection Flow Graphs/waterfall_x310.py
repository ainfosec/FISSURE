...
# Title: Waterfall X310
# Generated: Tue Oct 19 19:35:38 2021
##################################################
...
class waterfall_x310(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Waterfall X310")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Waterfall X310")
        ...
        self.settings = Qt.QSettings("GNU Radio", "waterfall_x310")
...
def main(top_block_cls=waterfall_x310, options=None):
