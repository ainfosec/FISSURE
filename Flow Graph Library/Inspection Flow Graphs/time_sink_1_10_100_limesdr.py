...
# Title: Time Sink 1 10 100 Limesdr
# Generated: Thu Sep 16 20:49:01 2021
##################################################
...
class time_sink_1_10_100_limesdr(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Time Sink 1 10 100 Limesdr")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Time Sink 1 10 100 Limesdr")
        ...
        self.settings = Qt.QSettings("GNU Radio", "time_sink_1_10_100_limesdr")
        ...
        self.connect((self.limesdr_source_0, 0), (self.blocks_keep_one_in_n_0_0, 0))
...
def main(top_block_cls=time_sink_1_10_100_limesdr, options=None):
