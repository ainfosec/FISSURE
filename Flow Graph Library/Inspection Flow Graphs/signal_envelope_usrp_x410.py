...
# Title: Signal Envelope Usrp X410
...
class signal_envelope_usrp_x410(gr.top_block, Qt.QWidget):

    def __init__(self, ip_address="192.168.140.2", rx_usrp_channel="A:0"):
        gr.top_block.__init__(self, "Signal Envelope Usrp X410", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Signal Envelope Usrp X410")
        ...
        self.settings = Qt.QSettings("GNU Radio", "signal_envelope_usrp_x410")
...
def main(top_block_cls=signal_envelope_usrp_x410, options=None):
    if options is None:
