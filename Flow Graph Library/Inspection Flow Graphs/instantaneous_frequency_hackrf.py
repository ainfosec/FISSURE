...
# Generated: Sun Aug 21 14:45:08 2022
##################################################
...
class instantaneous_frequency_hackrf(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Instantaneous Frequency Hackrf")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Instantaneous Frequency Hackrf")
        ...
        self.settings = Qt.QSettings("GNU Radio", "instantaneous_frequency_hackrf")
        ...
        self.osmosdr_source_0.set_bb_gain(rx_hackrf_gain, 0)
    ...
    def get_rx_hackrf_gain(self):
        return self.rx_hackrf_gain

    def set_rx_hackrf_gain(self, rx_hackrf_gain):
        self.rx_hackrf_gain = rx_hackrf_gain
        self.osmosdr_source_0.set_bb_gain(self.rx_hackrf_gain, 0)
...
def main(top_block_cls=instantaneous_frequency_hackrf, options=None):
