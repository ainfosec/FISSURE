...
# Title: Iq Playback Single X310
# Generated: Mon Sep  6 11:46:28 2021
##################################################
...
class iq_playback_single_x310(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Iq Playback Single X310")
...
def main(top_block_cls=iq_playback_single_x310, options=None):
