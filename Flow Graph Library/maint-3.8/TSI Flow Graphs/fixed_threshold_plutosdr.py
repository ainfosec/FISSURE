...
class fixed_threshold_plutosdr(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, antenna_default='', channel_default='', gain_default='64', ip_address="192.168.2.1", rx_freq_default='2412', sample_rate_default='20e6', serial='', threshold_default='0'):
        ...
        self.logpwrfft_x_0 = logpwrfft.logpwrfft_c(
            ...
            average=False,
            shift=True)
        self.iio_pluto_source_0 = iio.pluto_source("ip:" + str(ip_address), int(rx_freq*1e6), int(samp_rate), 20000000, 32768, True, True, True, 'manual', rx_gain, '', True)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.iio_pluto_source_0.set_params(int(self.rx_freq*1e6), int(self.samp_rate), 20000000, True, True, True, 'manual', self.rx_gain, '', True)
...
def argument_parser():
    ...
    parser.add_argument(
        "--gain-default", dest="gain_default", type=str, default='64',
        help="Set 64 [default=%(default)r]")
    parser.add_argument(
