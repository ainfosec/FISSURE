...
# Title: Mode S Ppm Usrpb210 Stdout Brief
...
class Mode_S_PPM_USRPB210_stdout_brief(gr.top_block):

    def __init__(self, antenna="TX/RX", channel="A:A", freq='1090e6', gain='70', samp_rate='2e6', serial="False", threshold='0.01'):
        gr.top_block.__init__(self, "Mode S Ppm Usrpb210 Stdout Brief")
        ...
        # Variables
        ##################################################
        self.notes = notes = "Prints formatted decoded ADSB data (gr-adsb) originating from an SDR (2 MS/s) to stdout with the brief option selected."
        ...
        self.adsb_decoder_0_0 = adsb.decoder("All Messages", "None", "Brief")
...
def main(top_block_cls=Mode_S_PPM_USRPB210_stdout_brief, options=None):
    if options is None:
