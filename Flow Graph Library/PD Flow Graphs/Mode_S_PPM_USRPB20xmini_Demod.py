...
# Title: Mode S Ppm Usrpb20Xmini Demod
...
class Mode_S_PPM_USRPB20xmini_Demod(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Mode S Ppm Usrpb20Xmini Demod")
...
def main(top_block_cls=Mode_S_PPM_USRPB20xmini_Demod, options=None):
