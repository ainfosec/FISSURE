...
class Mode_S_PPM_USRPB210_Demod(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Mode S Ppm Usrpb210 Demod")
...
def main(top_block_cls=Mode_S_PPM_USRPB210_Demod, options=None):
