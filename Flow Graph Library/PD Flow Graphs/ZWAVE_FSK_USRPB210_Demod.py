...
class ZWAVE_FSK_USRPB210_Demod(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Zwave Fsk Usrpb210 Demod", catch_exceptions=True)
...
def main(top_block_cls=ZWAVE_FSK_USRPB210_Demod, options=None):
    tb = top_block_cls()
