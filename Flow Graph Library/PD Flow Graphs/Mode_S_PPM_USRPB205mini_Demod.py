...
# Title: Mode S Ppm Usrpb205Mini Demod
# Generated: Sat Jan  1 22:05:36 2022
##################################################
...
class Mode_S_PPM_USRPB205mini_Demod(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Mode S Ppm Usrpb205Mini Demod")
...
def main(top_block_cls=Mode_S_PPM_USRPB205mini_Demod, options=None):
