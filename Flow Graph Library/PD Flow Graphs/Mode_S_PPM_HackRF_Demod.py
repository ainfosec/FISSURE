...
class Mode_S_PPM_HackRF_Demod(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Mode S Ppm Hackrf Demod")
...
def main(top_block_cls=Mode_S_PPM_HackRF_Demod, options=None):
