...
# Title: Mode S Ppm Usrpx310 Demod
# Generated: Tue Sep  1 11:26:37 2020
##################################################
...
class Mode_S_PPM_USRPX310_Demod(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Mode S Ppm Usrpx310 Demod")
...
def main(top_block_cls=Mode_S_PPM_USRPX310_Demod, options=None):
