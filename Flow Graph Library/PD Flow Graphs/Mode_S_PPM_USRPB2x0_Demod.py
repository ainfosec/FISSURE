...
# Title: Mode S Ppm Usrpb2X0 Demod
...
class Mode_S_PPM_USRPB2x0_Demod(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Mode S Ppm Usrpb2X0 Demod")
...
def main(top_block_cls=Mode_S_PPM_USRPB2x0_Demod, options=None):
