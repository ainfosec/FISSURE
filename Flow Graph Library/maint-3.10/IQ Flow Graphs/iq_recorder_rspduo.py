...
class iq_recorder_rspduo(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Iq Recorder Rspduo", catch_exceptions=True)
        ...
        self.sdrplay3_rspduo_0.set_sample_rate((float(sample_rate)*1e6), False)
        ...
        self.connect((self.sdrplay3_rspduo_0, 0), (self.blocks_skiphead_0, 0))
    ...
    def set_sample_rate(self, sample_rate):
        ...
        self.sdrplay3_rspduo_0.set_sample_rate((float(self.sample_rate)*1e6), False)
...
def main(top_block_cls=iq_recorder_rspduo, options=None):
    tb = top_block_cls()
