...
# Title: Mode S Ppm Usrpx310 Fields
# Generated: Thu Oct  7 21:09:17 2021
##################################################
...
class Mode_S_PPM_USRPX310_Fields(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Mode S Ppm Usrpx310 Fields")
...
def main(top_block_cls=Mode_S_PPM_USRPX310_Fields, options=None):
