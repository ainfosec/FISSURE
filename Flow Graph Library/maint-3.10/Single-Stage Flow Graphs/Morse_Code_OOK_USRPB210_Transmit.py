...
import time
import Morse_Code_OOK_USRPB210_Transmit_epy_block_0 as epy_block_0  # embedded python block
import foo
import pmt
...
class Morse_Code_OOK_USRPB210_Transmit(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Morse Code Ook Usrpb210 Transmit", catch_exceptions=True)
...
def main(top_block_cls=Morse_Code_OOK_USRPB210_Transmit, options=None):
    tb = top_block_cls()
