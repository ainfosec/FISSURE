...
import Morse_Code_OOK_USRPB210_File_epy_block_0 as epy_block_0  # embedded python block
import foo
import pmt
...
class Morse_Code_OOK_USRPB210_File(gr.top_block):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Morse Code Ook Usrpb210 File", catch_exceptions=True)
