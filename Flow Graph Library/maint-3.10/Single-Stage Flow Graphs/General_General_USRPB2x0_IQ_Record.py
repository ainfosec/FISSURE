...
# Title: General General Usrpb2X0 Iq Record
...
class General_General_USRPB2x0_IQ_Record(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "General General Usrpb2X0 Iq Record", catch_exceptions=True)
        ...
        self.uhd_usrp_source_0_0.set_center_freq(float(rx_frequency), 0)
    ...
    def set_rx_frequency(self, rx_frequency):
        ...
        self.uhd_usrp_source_0_0.set_center_freq(float(self.rx_frequency), 0)
...
def main(top_block_cls=General_General_USRPB2x0_IQ_Record, options=None):
    tb = top_block_cls()
