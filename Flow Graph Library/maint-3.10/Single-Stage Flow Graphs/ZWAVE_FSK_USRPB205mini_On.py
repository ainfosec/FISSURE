...
class ZWAVE_FSK_USRPB205mini_On(gr.top_block):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Zwave Fsk Usrpb205Mini On", catch_exceptions=True)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.zwave_poore_message_generator_pdu_0, 'out'), (self.pdu_pdu_to_tagged_stream_0, 'pdus'))
