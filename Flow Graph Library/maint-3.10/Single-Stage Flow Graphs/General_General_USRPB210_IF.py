...
# Title: General General Usrpb210 If
...
class General_General_USRPB210_IF(gr.top_block, Qt.QWidget):

    def __init__(self, rx_usrp_channel="A:A", serial="False"):
        gr.top_block.__init__(self, "General General Usrpb210 If", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("General General Usrpb210 If")
        ...
        self.settings = Qt.QSettings("GNU Radio", "General_General_USRPB210_IF")
        ...
        self.notes = notes = "Test attack for flow graphs with GUIs."
...
def main(top_block_cls=General_General_USRPB210_IF, options=None):
    if options is None:
