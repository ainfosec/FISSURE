...
#################################################
def getArguments():
    flow_graph_filepath = '/home/user/FISSURE/Flow Graph Library/Single-Stage Flow Graphs/Mode_S_PPM_USRPB210_stdout_verbose.py'
    samp_rate = '2e6'
    freq = '1090e6'
    gain = '70'
    antenna = 'TX/RX'
    ...
    threshold = '0.01'
    run_with_sudo = 'False'
    notes = "Prints formatted decoded ADSB data (gr-adsb) originating from an SDR (2 MS/s) to stdout with the verbose option selected."
