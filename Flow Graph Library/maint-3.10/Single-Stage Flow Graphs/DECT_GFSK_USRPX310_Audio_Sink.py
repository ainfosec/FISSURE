...
class DECT_GFSK_USRPX310_Audio_Sink(gr.top_block):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Dect Gfsk Usrpx310 Audio Sink", catch_exceptions=True)
    ...
    def set_dect_occupied_bandwidth(self, dect_occupied_bandwidth):
        ...
        self.rational_resampler_xxx_1.set_taps(firdes.low_pass_2(1, 3*self.baseband_sampling_rate, self.dect_occupied_bandwidth/2, (self.dect_channel_bandwidth - self.dect_occupied_bandwidth)/2, 30))
