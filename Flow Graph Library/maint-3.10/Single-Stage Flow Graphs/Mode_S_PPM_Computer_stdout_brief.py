...
# Title: Mode S Ppm Computer Stdout Brief
...
class Mode_S_PPM_Computer_stdout_brief(gr.top_block):

    def __init__(self, filepath="/home/laptop1/Documents/ads-b_signals/airport/adsb.iq", samp_rate='2e6', threshold='0.01'):
        gr.top_block.__init__(self, "Mode S Ppm Computer Stdout Brief", catch_exceptions=True)
...
def main(top_block_cls=Mode_S_PPM_Computer_stdout_brief, options=None):
    if options is None:
