...
# Title: General General Usrpb2X0 Iq Playback Repeat
...
class General_General_USRPB2x0_IQ_Playback_Repeat(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "General General Usrpb2X0 Iq Playback Repeat", catch_exceptions=True)
        ...
        self.notes = notes = "Replays an IQ file on repeat."
...
def main(top_block_cls=General_General_USRPB2x0_IQ_Playback_Repeat, options=None):
    tb = top_block_cls()
