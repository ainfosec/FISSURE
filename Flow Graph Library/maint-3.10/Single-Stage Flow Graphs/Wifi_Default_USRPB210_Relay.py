...
class Wifi_Default_USRPB210_Relay(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Wifi Default Usrpb210 Relay", catch_exceptions=True)
...
def main(top_block_cls=Wifi_Default_USRPB210_Relay, options=None):
    tb = top_block_cls()
