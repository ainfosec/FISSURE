...
# Title: Fm Radio Fm Bladerf2 From Wav File
...
class FM_Radio_FM_bladeRF2_From_Wav_File(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Fm Radio Fm Bladerf2 From Wav File", catch_exceptions=True)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_wfm_tx_0, 0), (self.soapy_bladerf_sink_0, 0))
    ...
    def set_sample_rate(self, sample_rate):
        ...
        self.soapy_bladerf_sink_0.set_sample_rate(0, self.sample_rate)
...
def main(top_block_cls=FM_Radio_FM_bladeRF2_From_Wav_File, options=None):
    tb = top_block_cls()
