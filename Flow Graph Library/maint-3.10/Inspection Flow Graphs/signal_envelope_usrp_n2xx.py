...
# Title: Signal Envelope Usrp N2Xx
...
class signal_envelope_usrp_n2xx(gr.top_block, Qt.QWidget):

    def __init__(self, ip_address="192.168.10.2", rx_usrp_channel="A:0"):
        gr.top_block.__init__(self, "Signal Envelope Usrp N2Xx", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Signal Envelope Usrp N2Xx")
        ...
        self.settings = Qt.QSettings("GNU Radio", "signal_envelope_usrp_n2xx")
...
def main(top_block_cls=signal_envelope_usrp_n2xx, options=None):
    if options is None:
