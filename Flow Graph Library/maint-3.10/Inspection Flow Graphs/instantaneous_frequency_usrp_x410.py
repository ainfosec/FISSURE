...
# Title: Instantaneous Frequency Usrp X410
...
class instantaneous_frequency_usrp_x410(gr.top_block, Qt.QWidget):

    def __init__(self, ip_address="192.168.140.2", rx_usrp_channel="A:0"):
        gr.top_block.__init__(self, "Instantaneous Frequency Usrp X410", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Instantaneous Frequency Usrp X410")
        ...
        self.settings = Qt.QSettings("GNU Radio", "instantaneous_frequency_usrp_x410")
...
def main(top_block_cls=instantaneous_frequency_usrp_x410, options=None):
    if options is None:
