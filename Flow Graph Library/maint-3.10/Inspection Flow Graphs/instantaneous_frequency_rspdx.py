...
# Title: Instantaneous Frequency Rspdx
...
class instantaneous_frequency_rspdx(gr.top_block, Qt.QWidget):

    def __init__(self, serial='0'):
        gr.top_block.__init__(self, "Instantaneous Frequency Rspdx", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Instantaneous Frequency Rspdx")
        ...
        self.settings = Qt.QSettings("GNU Radio", "instantaneous_frequency_rspdx")
...
def main(top_block_cls=instantaneous_frequency_rspdx, options=None):
    if options is None:
