...
# Title: Instantaneous Frequency Rspduo
...
class instantaneous_frequency_rspduo(gr.top_block, Qt.QWidget):

    def __init__(self, serial='0'):
        gr.top_block.__init__(self, "Instantaneous Frequency Rspduo", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Instantaneous Frequency Rspduo")
        ...
        self.settings = Qt.QSettings("GNU Radio", "instantaneous_frequency_rspduo")
...
def main(top_block_cls=instantaneous_frequency_rspduo, options=None):
    if options is None:
