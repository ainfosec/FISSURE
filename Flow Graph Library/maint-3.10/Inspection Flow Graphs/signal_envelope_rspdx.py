...
class signal_envelope_rspdx(gr.top_block, Qt.QWidget):

    def __init__(self, serial='0'):
        gr.top_block.__init__(self, "Signal Envelope Rspdx", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Signal Envelope Rspdx")
        ...
        self.settings = Qt.QSettings("GNU Radio", "signal_envelope_rspdx")
        ...
        self.sdrplay3_rspdx_0.set_center_freq(float(rx_frequency), False)
    ...
    def set_rx_frequency(self, rx_frequency):
        ...
        self.sdrplay3_rspdx_0.set_center_freq(float(self.rx_frequency), False)
...
def main(top_block_cls=signal_envelope_rspdx, options=None):
    if options is None:
