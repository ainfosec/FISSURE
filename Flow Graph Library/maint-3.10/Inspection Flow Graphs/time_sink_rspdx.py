...
class time_sink_rspdx(gr.top_block, Qt.QWidget):

    def __init__(self, serial='0'):
        gr.top_block.__init__(self, "Time Sink Rspdx", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Time Sink Rspdx")
        ...
        self.settings = Qt.QSettings("GNU Radio", "time_sink_rspdx")
...
def main(top_block_cls=time_sink_rspdx, options=None):
    if options is None:
