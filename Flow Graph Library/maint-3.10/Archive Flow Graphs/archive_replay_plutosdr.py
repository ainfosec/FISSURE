...
class archive_replay_plutosdr(gr.top_block):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Archive Replay Plutosdr", catch_exceptions=True)
        ...
        self.iio_pluto_sink_0.set_frequency(int(tx_frequency))
        self.iio_pluto_sink_0.set_samplerate(int(sample_rate))
    ...
    def set_tx_frequency(self, tx_frequency):
        ...
        self.iio_pluto_sink_0.set_frequency(int(self.tx_frequency))
    ...
    def set_sample_rate(self, sample_rate):
        ...
        self.iio_pluto_sink_0.set_samplerate(int(self.sample_rate))
