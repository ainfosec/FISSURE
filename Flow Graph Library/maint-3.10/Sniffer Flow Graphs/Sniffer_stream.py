...
class Sniffer_stream(gr.top_block):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Sniffer Stream", catch_exceptions=True)
        ...
        self.zeromq_sub_source_0_0 = zeromq.sub_source(gr.sizeof_char, 1, "tcp://" + address, 100, True, (-1), '', False)
