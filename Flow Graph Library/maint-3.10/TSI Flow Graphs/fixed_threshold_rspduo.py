...
import fixed_threshold_rspduo_epy_block_0 as epy_block_0  # embedded python block
import numpy as np
import random
import sip
import time
...
class fixed_threshold_rspduo(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, antenna_default='', channel_default='', gain_default='0', ip_address='', rx_freq_default='102.4', sample_rate_default='2e6', serial='', threshold_default='0'):
        ...
        self.settings = Qt.QSettings("GNU Radio", "fixed_threshold_rspduo")
        ...
        self.sdrplay3_rspduo_0.set_sample_rate(float(samp_rate), False)
        self.sdrplay3_rspduo_0.set_center_freq((float(rx_freq)*1e6), False)
        ...
        self.sdrplay3_rspduo_0.set_gain(-((59-float(rx_gain))), 'IF', False)
        ...
        self.connect((self.sdrplay3_rspduo_0, 0), (self.logpwrfft_x_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.sdrplay3_rspduo_0.set_sample_rate(float(self.samp_rate), False)
    ...
    def set_rx_gain(self, rx_gain):
        ...
        self.sdrplay3_rspduo_0.set_gain(-((59-float(self.rx_gain))), 'IF', False)
    ...
    def set_rx_freq(self, rx_freq):
        ...
        self.sdrplay3_rspduo_0.set_center_freq((float(self.rx_freq)*1e6), False)
...
def main(top_block_cls=fixed_threshold_rspduo, options=None):
    if options is None:
