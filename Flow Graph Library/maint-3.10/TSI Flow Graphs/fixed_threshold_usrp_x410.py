...
import fixed_threshold_usrp_x410_epy_block_0 as epy_block_0  # embedded python block
import numpy as np
import random
import sip
...
class fixed_threshold_usrp_x410(gr.top_block, Qt.QWidget):

    def __init__(self, antenna_default='TX/RX', channel_default='A:0', gain_default='50', ip_address='192.168.40.2', rx_freq_default='2412', sample_rate_default='20e6', serial='False', threshold_default='0'):
        ...
        self.settings = Qt.QSettings("GNU Radio", "fixed_threshold_usrp_x410")
        ...
        self._samp_rate_options = [1000000.0, 2000000.0, 5000000.0, 10000000.0, 20000000.0, 50000000.0, 100000000.0, 200000000.0, 300000000.0, 400000000.0, 500000000.0]
        # Create the labels list
        self._samp_rate_labels = ['1 MS/s', '2 MS/s', '5 MS/s', '10 MS/s', '20 MS/s', '50 MS/s', '100 MS/s', '200 MS/s', '300 MS/s', '400 MS/s', '500 MS/s']
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._rx_gain_range = Range(0, 60, 1, float(gain_default), 200)
        ...
        for c in range(0, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
        # Create the options list
        self._rx_antenna_options = ['TX/RX', 'RX1', 'RX2']
        # Create the labels list
        self._rx_antenna_labels = ['TX/RX', 'RX1', 'RX2']
        # Create the combo box
...
def argument_parser():
    ...
    parser.add_argument(
        "--channel-default", dest="channel_default", type=str, default='A:0',
    ...
    parser.add_argument(
        ...
        help="Set 192.168.40.2 [default=%(default)r]")
    parser.add_argument(
...
def main(top_block_cls=fixed_threshold_usrp_x410, options=None):
    if options is None:
