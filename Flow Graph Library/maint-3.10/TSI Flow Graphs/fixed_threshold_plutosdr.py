...
import fixed_threshold_plutosdr_epy_block_0 as epy_block_0  # embedded python block
import numpy as np
import random
import sip
import time
...
class fixed_threshold_plutosdr(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, antenna_default='', channel_default='', gain_default='64', ip_address="192.168.2.1", rx_freq_default='2412', sample_rate_default='20e6', serial='', threshold_default='0'):
        ...
        self.iio_pluto_source_0.set_frequency((int(rx_freq*1e6)))
    ...
    def set_rx_freq(self, rx_freq):
        ...
        self.iio_pluto_source_0.set_frequency((int(self.rx_freq*1e6)))
