...
class wideband_rspdx_r2(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Wideband Rspdx R2", catch_exceptions=True)
        ...
        self.sdrplay3_rspdxr2_0.set_center_freq(float(rx_freq), False)
        ...
        self.sdrplay3_rspdxr2_0.set_gain(-((59-float(gain))), 'IF', False)
        ...
        self.connect((self.sdrplay3_rspdxr2_0, 0), (self.analog_pwr_squelch_xx_0, 0))
    ...
    def set_rx_freq(self, rx_freq):
        ...
        self.sdrplay3_rspdxr2_0.set_center_freq(float(self.rx_freq), False)
    ...
    def set_gain(self, gain):
        self.gain = gain
        self.sdrplay3_rspdxr2_0.set_gain(-((59-float(self.gain))), 'IF', False)
...
def main(top_block_cls=wideband_rspdx_r2, options=None):
    tb = top_block_cls()
