...
import fixed_threshold_rspdx_r2_epy_block_0 as epy_block_0  # embedded python block
import numpy as np
import random
import sip
import time
...
class fixed_threshold_rspdx_r2(gr.top_block, Qt.QWidget):

    def __init__(self, antenna_default='', channel_default='', gain_default='0', ip_address='', rx_freq_default='102.4', sample_rate_default='2e6', serial='', threshold_default='0'):
        ...
        self.settings = Qt.QSettings("GNU Radio", "fixed_threshold_rspdx_r2")
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._rx_gain_range = Range(0, 59, 1, float(gain_default), 200)
        ...
        for c in range(0, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._rx_freq_range = Range(0.001, 2000, .1, float(rx_freq_default), 200)
        ...
        self.sdrplay3_rspdxr2_0.set_sample_rate(float(samp_rate), False)
        self.sdrplay3_rspdxr2_0.set_center_freq((float(rx_freq)*1e6), False)
        ...
        self.sdrplay3_rspdxr2_0.set_gain(-((59-float(rx_gain))), 'IF', False)
        ...
        self.connect((self.sdrplay3_rspdxr2_0, 0), (self.logpwrfft_x_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.sdrplay3_rspdxr2_0.set_sample_rate(float(self.samp_rate), False)
    ...
    def set_rx_gain(self, rx_gain):
        ...
        self.sdrplay3_rspdxr2_0.set_gain(-((59-float(self.rx_gain))), 'IF', False)
    ...
    def set_rx_freq(self, rx_freq):
        ...
        self.sdrplay3_rspdxr2_0.set_center_freq((float(self.rx_freq)*1e6), False)
...
def argument_parser():
    ...
    parser.add_argument(
        "--gain-default", dest="gain_default", type=str, default='0',
...
def main(top_block_cls=fixed_threshold_rspdx_r2, options=None):
    if options is None:
