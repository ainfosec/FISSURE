...
class wideband_b20xmini(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Wideband B20Xmini", catch_exceptions=True)
...
def main(top_block_cls=wideband_b20xmini, options=None):
    tb = top_block_cls()
