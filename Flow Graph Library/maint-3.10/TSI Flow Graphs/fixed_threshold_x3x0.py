...
import fixed_threshold_x3x0_epy_block_0 as epy_block_0  # embedded python block
import numpy as np
import random
import sip
...
def argument_parser():
    ...
    parser.add_argument(
        "--gain-default", dest="gain_default", type=str, default='30',
        help="Set 30 [default=%(default)r]")
    parser.add_argument(
