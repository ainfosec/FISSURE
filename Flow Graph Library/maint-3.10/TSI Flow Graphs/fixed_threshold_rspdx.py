...
import fixed_threshold_rspdx_epy_block_0 as epy_block_0  # embedded python block
import numpy as np
import random
import sip
import time
...
class fixed_threshold_rspdx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, antenna_default='', channel_default='', gain_default='0', ip_address='', rx_freq_default='102.4', sample_rate_default='2e6', serial='', threshold_default='0'):
        ...
        self.settings = Qt.QSettings("GNU Radio", "fixed_threshold_rspdx")
        ...
        self.sdrplay3_rspdx_0.set_center_freq((float(rx_freq)*1e6), False)
    ...
    def set_rx_freq(self, rx_freq):
        ...
        self.sdrplay3_rspdx_0.set_center_freq((float(self.rx_freq)*1e6), False)
...
def main(top_block_cls=fixed_threshold_rspdx, options=None):
    if options is None:
