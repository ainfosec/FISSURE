...
class wideband_usrp_x410(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Wideband Usrp X410", catch_exceptions=True)
...
def main(top_block_cls=wideband_usrp_x410, options=None):
    tb = top_block_cls()
