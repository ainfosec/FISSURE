...
import fixed_threshold_usrp2_epy_block_0 as epy_block_0  # embedded python block
import numpy as np
import random
import sip
...
class fixed_threshold_usrp2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, antenna_default='J1', channel_default='A:0', gain_default='30', ip_address='192.168.10.2', rx_freq_default='2412', sample_rate_default='20e6', serial='False', threshold_default='0'):
        ...
        self.settings = Qt.QSettings("GNU Radio", "fixed_threshold_usrp2")
...
def argument_parser():
    ...
    parser.add_argument(
        "--antenna-default", dest="antenna_default", type=str, default='J1',
        help="Set J1 [default=%(default)r]")
    parser.add_argument(
...
def main(top_block_cls=fixed_threshold_usrp2, options=None):
    if options is None:
