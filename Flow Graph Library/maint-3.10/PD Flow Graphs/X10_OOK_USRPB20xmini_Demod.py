...
# Title: X10 Ook Usrpb20Xmini Demod
...
class X10_OOK_USRPB20xmini_Demod(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "X10 Ook Usrpb20Xmini Demod", catch_exceptions=True)
...
def main(top_block_cls=X10_OOK_USRPB20xmini_Demod, options=None):
    tb = top_block_cls()
