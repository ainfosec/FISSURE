...
# Title: Zwave Fsk Usrpb2X0 Demod
...
class ZWAVE_FSK_USRPB2x0_Demod(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Zwave Fsk Usrpb2X0 Demod", catch_exceptions=True)
        ...
        self.msg_connect((self.zwave_poore_decoder_0, 'bytes'), (self.zeromq_pub_msg_sink_0, 'in'))
...
def main(top_block_cls=ZWAVE_FSK_USRPB2x0_Demod, options=None):
    tb = top_block_cls()
