...
class paint_tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.paint_paint_bc_0 = paint.paint_bc(1920, 12, paint.EQUALIZATION_OFF, paint.INTERNAL, 1)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'marcy.bin', True, 0, 0)
