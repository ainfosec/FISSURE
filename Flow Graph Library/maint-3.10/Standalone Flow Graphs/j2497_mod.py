...
class j2497_mod(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "J2497 Mod", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("J2497 Mod")
        ...
        self.settings = Qt.QSettings("GNU Radio", "j2497_mod")
        ...
        self._tx_gain_range = Range(0, 80, 1, 20, 200)
        ...
        self._tx_freq_range = Range(100e3, 150e6, 100e3, 125e6, 200)
        ...
        # Connections
        ##################################################
        self.connect((self.j2497_encoder_0, 0), (self.osmosdr_sink_0, 0))
...
def main(top_block_cls=j2497_mod, options=None):
