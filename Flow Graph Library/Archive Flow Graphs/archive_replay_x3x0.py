...
class archive_replay_x3x0(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Archive Replay X3X0", catch_exceptions=True)
...
def main(top_block_cls=archive_replay_x3x0, options=None):
    tb = top_block_cls()
