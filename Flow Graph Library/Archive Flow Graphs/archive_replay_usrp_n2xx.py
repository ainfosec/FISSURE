...
# Title: Archive Replay Usrp N2Xx
# Generated: Sun Sep 18 22:09:37 2022
##################################################
...
class archive_replay_usrp_n2xx(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Archive Replay Usrp N2Xx")
...
def main(top_block_cls=archive_replay_usrp_n2xx, options=None):
