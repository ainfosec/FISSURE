...
# Title: Archive Replay Bladerf
# Generated: Thu Sep 22 19:32:10 2022
##################################################
...
class archive_replay_bladerf(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Archive Replay Bladerf")
...
def main(top_block_cls=archive_replay_bladerf, options=None):
