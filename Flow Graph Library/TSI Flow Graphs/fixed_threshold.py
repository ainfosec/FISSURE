...
class fixed_threshold(gr.top_block, Qt.QWidget):

    def __init__(self, antenna_default='TX/RX', channel_default='A:A', gain_default='70', ip_address='', rx_freq_default='2412', sample_rate_default='20e6', serial='False', threshold_default='0'):
        ...
        self.settings = Qt.QSettings("GNU Radio", "fixed_threshold")
        ...
        self._thresh_adj_range = Range(-200, 100, 1, float(threshold_default), 200)
        ...
        self._samp_rate_labels = ['1 MS/s', '5 MS/s', '10 MS/s', '20 MS/s']
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._rx_gain_range = Range(0, 90, 1, float(gain_default), 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, -400000, .2, 0, 0)
...
def argument_parser():
    ...
    parser.add_argument(
        "--gain-default", dest="gain_default", type=str, default='70',
...
def main(top_block_cls=fixed_threshold, options=None):
    if options is None:
