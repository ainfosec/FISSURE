...
# Title: Wideband B210
# Generated: Thu Jun  2 17:56:29 2022
##################################################
...
class wideband_b210(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Wideband B210")
        ...
        self.connect((self.uhd_usrp_source_0_0, 0), (self.analog_pwr_squelch_xx_0, 0))
...
def main(top_block_cls=wideband_b210, options=None):
