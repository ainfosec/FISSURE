...
# Title: Fixed Threshold Bladerf2
...
class fixed_threshold_bladerf2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, antenna_default='', channel_default='', gain_default='10', ip_address='', rx_freq_default='2412', sample_rate_default='20e6', serial='0', threshold_default='0'):
        gr.top_block.__init__(self, "Fixed Threshold Bladerf2")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Fixed Threshold Bladerf2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "fixed_threshold_bladerf2")
...
def main(top_block_cls=fixed_threshold_bladerf2, options=None):
    if options is None:
