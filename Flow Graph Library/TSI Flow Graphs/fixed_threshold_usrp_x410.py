...
# Title: Fixed Threshold Usrp X410
...
class fixed_threshold_usrp_x410(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, antenna_default='TX/RX', channel_default='A:0', gain_default='50', ip_address='192.168.40.2', rx_freq_default='2412', sample_rate_default='20e6', serial='False', threshold_default='0'):
        gr.top_block.__init__(self, "Fixed Threshold Usrp X410")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Fixed Threshold Usrp X410")
        ...
        for c in range(0, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._rx_freq_range = Range(1, 7200, 0.1, float(rx_freq_default), 200)
...
def argument_parser():
    ...
    parser.add_option(
        "", "--antenna-default", dest="antenna_default", type="string", default='TX/RX',
        help="Set TX/RX [default=%default]")
    parser.add_option(
        "", "--channel-default", dest="channel_default", type="string", default='A:0',
        help="Set A:0 [default=%default]")
    parser.add_option(
        "", "--gain-default", dest="gain_default", type="string", default='50',
        help="Set 50 [default=%default]")
    parser.add_option(
        "", "--ip-address", dest="ip_address", type="string", default='192.168.40.2',
        help="Set 192.168.40.2 [default=%default]")
    parser.add_option(
