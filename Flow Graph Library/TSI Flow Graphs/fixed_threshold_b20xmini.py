...
# Title: Fixed Threshold B20Xmini
...
class fixed_threshold_b20xmini(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, antenna_default='TX/RX', channel_default='A:A', gain_default='60', ip_address='', rx_freq_default='2412', sample_rate_default='20e6', serial='False', threshold_default='0'):
        gr.top_block.__init__(self, "Fixed Threshold B20Xmini")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Fixed Threshold B20Xmini")
        ...
        self.settings = Qt.QSettings("GNU Radio", "fixed_threshold_b20xmini")
...
def main(top_block_cls=fixed_threshold_b20xmini, options=None):
    if options is None:
