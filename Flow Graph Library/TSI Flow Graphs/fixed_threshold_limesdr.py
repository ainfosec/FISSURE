...
class fixed_threshold_limesdr(gr.top_block, Qt.QWidget):

    def __init__(self, antenna_default='', channel_default='0', gain_default='60', ip_address='', rx_freq_default='2412', sample_rate_default='20e6', serial='', threshold_default='0'):
        gr.top_block.__init__(self, "Fixed Threshold Limesdr")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Fixed Threshold Limesdr")
        ...
        self.settings = Qt.QSettings("GNU Radio", "fixed_threshold_limesdr")
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._rx_gain_range = Range(0, 70, 1, float(gain_default), 200)
        ...
        self.limesdr_source_0.set_center_freq(rx_freq*1e6, 0)
        ...
        self.connect((self.limesdr_source_0, 0), (self.blocks_stream_to_vector_decimator_0, 0))
    ...
    def set_rx_freq(self, rx_freq):
        ...
        self.limesdr_source_0.set_center_freq(self.rx_freq*1e6, 0)
...
def argument_parser():
    ...
    parser.add_option(
        "", "--channel-default", dest="channel_default", type="string", default='0',
        help="Set 0 [default=%default]")
    parser.add_option(
        "", "--gain-default", dest="gain_default", type="string", default='60',
        help="Set 60 [default=%default]")
    parser.add_option(
        "", "--ip-address", dest="ip_address", type="string", default='',
        help="Set ip_address [default=%default]")
    parser.add_option(
...
def main(top_block_cls=fixed_threshold_limesdr, options=None):
    if options is None:
