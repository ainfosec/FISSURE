...
class fixed_threshold_hackrf(gr.top_block, Qt.QWidget):

    def __init__(self, antenna_default='', channel_default='', gain_default='20', ip_address='', rx_freq_default='2412', sample_rate_default='20e6', serial='False', threshold_default='0'):
        gr.top_block.__init__(self, "Fixed Threshold Hackrf")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Fixed Threshold Hackrf")
        ...
        self.settings = Qt.QSettings("GNU Radio", "fixed_threshold_hackrf")
...
def argument_parser():
    ...
    parser.add_option(
        "", "--gain-default", dest="gain_default", type="string", default='20',
        help="Set 20 [default=%default]")
    parser.add_option(
...
def main(top_block_cls=fixed_threshold_hackrf, options=None):
    if options is None:
