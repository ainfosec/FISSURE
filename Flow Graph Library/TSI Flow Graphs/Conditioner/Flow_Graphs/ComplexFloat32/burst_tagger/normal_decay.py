...
class normal_decay(gr.top_block):
    ...
    def __init__(self, decay="0.0002", filepath="", sample_rate="1e6", threshold="0.004"):
...
def argument_parser():
    ...
    parser.add_option(
        "", "--threshold", dest="threshold", type="string", default="0.004",
        help="Set 0.004 [default=%default]")
    return parser
