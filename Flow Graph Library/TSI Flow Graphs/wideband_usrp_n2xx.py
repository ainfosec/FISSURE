...
# Title: Wideband Usrp N2Xx
# Generated: Sun Sep 18 22:11:56 2022
##################################################
...
class wideband_usrp_n2xx(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Wideband Usrp N2Xx")
...
def main(top_block_cls=wideband_usrp_n2xx, options=None):
