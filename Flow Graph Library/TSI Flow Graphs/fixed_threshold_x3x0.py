...
class fixed_threshold_x3x0(gr.top_block, Qt.QWidget):

    def __init__(self, antenna_default='TX/RX', channel_default='A:0', gain_default='30', ip_address='192.168.40.2', rx_freq_default='2412', sample_rate_default='20e6', serial='False', threshold_default='0'):
        gr.top_block.__init__(self, "Fixed Threshold X3X0")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Fixed Threshold X3X0")
        ...
        self.settings = Qt.QSettings("GNU Radio", "fixed_threshold_x3x0")
...
def main(top_block_cls=fixed_threshold_x3x0, options=None):
    if options is None:
