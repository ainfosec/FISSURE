...
# Title: Fixed Threshold B205Mini
...
class fixed_threshold_b205mini(gr.top_block, Qt.QWidget):

    def __init__(self, antenna_default='TX/RX', channel_default='A:A', gain_default='60', ip_address='', rx_freq_default='2412', sample_rate_default='20e6', serial='False', threshold_default='0'):
        gr.top_block.__init__(self, "Fixed Threshold B205Mini")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Fixed Threshold B205Mini")
        ...
        self.settings = Qt.QSettings("GNU Radio", "fixed_threshold_b205mini")
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._rx_gain_range = Range(0, 80, 1, float(gain_default), 200)
...
def argument_parser():
    ...
    parser.add_option(
        "", "--channel-default", dest="channel_default", type="string", default='A:A',
...
def main(top_block_cls=fixed_threshold_b205mini, options=None):
    if options is None:
