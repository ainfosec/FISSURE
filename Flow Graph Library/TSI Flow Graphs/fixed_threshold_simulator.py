...
# Title: Fixed Threshold Simulator
...
class fixed_threshold_simulator(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, antenna_default="N/A", channel_default="N/A", gain_default='2', ip_address='', rx_freq_default='2412', sample_rate_default='20e6', serial='False', threshold_default='0'):
        gr.top_block.__init__(self, "Fixed Threshold Simulator")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Fixed Threshold Simulator")
        ...
        for c in range(0, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._signal_source_freq_range = Range(-1, 1, 0.01, 0, 200)
        self._signal_source_freq_win = RangeWidget(self._signal_source_freq_range, self.set_signal_source_freq, 'Signal Source Freq.:', "counter_slider", float)
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._rx_gain_range = Range(0, 10, 0.002, float(gain_default), 200)
        ...
        self.top_grid_layout.addWidget(self._qtgui_vector_sink_f_0_win, 8, 0, 8, 4)
        for r in range(8, 16):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, (samp_rate/2)*signal_source_freq, 10**rx_gain/100000, 0)
...
def argument_parser():
    ...
    parser.add_option(
        "", "--antenna-default", dest="antenna_default", type="string", default="N/A",
        help="Set N/A [default=%default]")
    parser.add_option(
        "", "--channel-default", dest="channel_default", type="string", default="N/A",
        help="Set N/A [default=%default]")
    parser.add_option(
        "", "--gain-default", dest="gain_default", type="string", default='2',
        help="Set 2 [default=%default]")
    parser.add_option(
