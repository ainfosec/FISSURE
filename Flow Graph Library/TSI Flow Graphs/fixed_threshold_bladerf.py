...
class fixed_threshold_bladerf(gr.top_block, Qt.QWidget):

    def __init__(self, antenna_default='', channel_default='', gain_default='10', ip_address='', rx_freq_default='2412', sample_rate_default='20e6', serial='0', threshold_default='0'):
        gr.top_block.__init__(self, "Fixed Threshold Bladerf")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Fixed Threshold Bladerf")
        ...
        self.settings = Qt.QSettings("GNU Radio", "fixed_threshold_bladerf")
        ...
        for c in range(0, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.osmosdr_source_0 = osmosdr.source( args="numchan=" + str(1) + " " + "bladerf=" + str(serial) )
        ...
        self.connect((self.osmosdr_source_0, 0), (self.blocks_stream_to_vector_decimator_0, 0))
...
def argument_parser():
    ...
    parser.add_option(
        "", "--gain-default", dest="gain_default", type="string", default='10',
        help="Set 10 [default=%default]")
    parser.add_option(
...
def main(top_block_cls=fixed_threshold_bladerf, options=None):
    if options is None:
