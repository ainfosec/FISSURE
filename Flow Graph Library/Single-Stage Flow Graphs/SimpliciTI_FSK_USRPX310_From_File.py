...
# Title: Simpliciti Fsk Usrpx310 From File
# Generated: Sun Jan  9 14:08:37 2022
##################################################
...
class SimpliciTI_FSK_USRPX310_From_File(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Simpliciti Fsk Usrpx310 From File")
...
def main(top_block_cls=SimpliciTI_FSK_USRPX310_From_File, options=None):
