...
# Title: Zwave Fsk Usrpb205Mini Receive
# Generated: Sat Jan  1 21:54:01 2022
##################################################
...
class ZWAVE_FSK_USRPB205mini_Receive(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Zwave Fsk Usrpb205Mini Receive")
...
def main(top_block_cls=ZWAVE_FSK_USRPB205mini_Receive, options=None):
