...
# Title: Zwave Fsk Usrpb205Mini Transmit
# Generated: Sat Jan  1 21:54:21 2022
##################################################
...
class ZWAVE_FSK_USRPB205mini_Transmit(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Zwave Fsk Usrpb205Mini Transmit")
...
def main(top_block_cls=ZWAVE_FSK_USRPB205mini_Transmit, options=None):
