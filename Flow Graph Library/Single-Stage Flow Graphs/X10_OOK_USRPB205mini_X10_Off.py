...
# Title: X10 Ook Usrpb205Mini X10 Off
# Generated: Sat Jan  1 21:51:05 2022
##################################################
...
class X10_OOK_USRPB205mini_X10_Off(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "X10 Ook Usrpb205Mini X10 Off")
        ...
        self.notes = notes = "Transmits an off message for a RadioShack Plug'n power outlet switch."
        self.data_code = data_code = "0x20"
...
def main(top_block_cls=X10_OOK_USRPB205mini_X10_Off, options=None):
