...
class Mode_S_PPM_HackRF_stdout(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Mode S Ppm Hackrf Stdout")
...
def main(top_block_cls=Mode_S_PPM_HackRF_stdout, options=None):
