...
# Title: Zwave Fsk Usrpb205Mini On
# Generated: Sat Jan  1 21:53:02 2022
##################################################
...
class ZWAVE_FSK_USRPB205mini_On(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Zwave Fsk Usrpb205Mini On")
        ...
        self.msg_length = msg_length = 14
        self.home_id = home_id = "fa1c0b48"
        self.frame_control = frame_control = "4107"
        self.destination_node_id = destination_node_id = "02"
        self.command_class = command_class = "26"
        self.command = command = "0163"

        ##################################################
        # Blocks
        ##################################################
        self.zwave_poore_message_generator_pdu_0 = zwave_poore.message_generator_pdu(repetition_interval, 1, home_id, source_node_id, frame_control, destination_node_id, command_class, command)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.zwave_poore_message_generator_pdu_0, 'out'), (self.blocks_pdu_to_tagged_stream_0, 'pdus'))
...
def main(top_block_cls=ZWAVE_FSK_USRPB205mini_On, options=None):
