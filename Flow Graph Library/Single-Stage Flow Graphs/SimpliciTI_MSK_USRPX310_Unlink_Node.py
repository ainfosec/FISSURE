...
# Title: Simpliciti Msk Usrpx310 Unlink Node
# Generated: Sun Jan  9 14:07:48 2022
##################################################
...
class SimpliciTI_MSK_USRPX310_Unlink_Node(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Simpliciti Msk Usrpx310 Unlink Node")
...
def main(top_block_cls=SimpliciTI_MSK_USRPX310_Unlink_Node, options=None):
