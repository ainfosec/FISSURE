...
# Title: Garage Door Ook Usrpb210 Transmit
# Generated: Sat Jan  1 21:43:32 2022
##################################################
...
class Garage_Door_OOK_USRPB210_Transmit(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Garage Door Ook Usrpb210 Transmit")
...
def main(top_block_cls=Garage_Door_OOK_USRPB210_Transmit, options=None):
