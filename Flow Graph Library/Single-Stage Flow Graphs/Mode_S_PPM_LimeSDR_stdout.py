...
# Title: Mode S Ppm Limesdr Stdout
# Generated: Sun Sep 19 09:39:09 2021
##################################################
...
class Mode_S_PPM_LimeSDR_stdout(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Mode S Ppm Limesdr Stdout")
...
def main(top_block_cls=Mode_S_PPM_LimeSDR_stdout, options=None):
