...
class Mode_S_PPM_RTL2832U_File_Sink(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Mode S Ppm Rtl2832U File Sink")
...
def main(top_block_cls=Mode_S_PPM_RTL2832U_File_Sink, options=None):
