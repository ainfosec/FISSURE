...
# Title: Simpliciti Fsk Usrpx310 Cw
# Generated: Sun Jan  9 14:09:30 2022
##################################################
...
class SimpliciTI_FSK_USRPX310_CW(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Simpliciti Fsk Usrpx310 Cw")
        ...
        self.notes = notes = "Jams SimpliciTI with a CW signal."
...
def main(top_block_cls=SimpliciTI_FSK_USRPX310_CW, options=None):
