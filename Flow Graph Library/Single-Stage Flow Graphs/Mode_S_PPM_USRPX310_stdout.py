...
# Title: Mode S Ppm Usrpx310 Stdout
# Generated: Sun Sep 19 09:41:44 2021
##################################################
...
class Mode_S_PPM_USRPX310_stdout(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Mode S Ppm Usrpx310 Stdout")
...
def main(top_block_cls=Mode_S_PPM_USRPX310_stdout, options=None):
