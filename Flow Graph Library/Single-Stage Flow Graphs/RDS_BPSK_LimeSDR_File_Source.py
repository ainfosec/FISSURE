...
class RDS_BPSK_LimeSDR_File_Source(gr.top_block):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Rds Bpsk Limesdr File Source", catch_exceptions=True)
        ...
        # Blocks
        ##################################################
        self.mmse_resampler_xx_2 = filter.mmse_resampler_cc(0, (sample_rate/10000)/100.0)
        self.mmse_resampler_xx_1 = filter.mmse_resampler_ff(0, 44.1/(sample_rate/1000))
        self.mmse_resampler_xx_0 = filter.mmse_resampler_ff(0, 44.1/(sample_rate/1000))
        ...
        self.gr_sig_source_x_0_1 = analog.sig_source_f(sample_rate, analog.GR_SIN_WAVE, 19e3, 1, 0, 0)
        self.gr_sig_source_x_0_0 = analog.sig_source_f(sample_rate, analog.GR_SIN_WAVE, 57e3, 1, 0, 0)
        self.gr_sig_source_x_0 = analog.sig_source_f(sample_rate, analog.GR_SIN_WAVE, 38e3, 1, 0, 0)
        ...
        self.connect((self.mmse_resampler_xx_2, 0), (self.limesdr_sink_0, 0))
    ...
    def set_sample_rate(self, sample_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.sample_rate, 2.5e3, .5e3, window.WIN_HAMMING, 6.76))
        self.mmse_resampler_xx_0.set_resamp_ratio(44.1/(self.sample_rate/1000))
        self.mmse_resampler_xx_1.set_resamp_ratio(44.1/(self.sample_rate/1000))
        self.mmse_resampler_xx_2.set_resamp_ratio((self.sample_rate/10000)/100.0)
