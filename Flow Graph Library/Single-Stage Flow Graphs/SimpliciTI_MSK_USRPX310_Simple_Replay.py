...
# Generated: Sun Jan  9 14:07:59 2022
##################################################
...
class SimpliciTI_MSK_USRPX310_Simple_Replay(gr.top_block):
    ...
    def __init__(self):
        ...
        self.tx_frequency = tx_frequency = 2477.9e6
        ...
        self.rx_frequency = rx_frequency = 2425.715e6
        self.notes = notes = "Relays SimpliciTI signals from one frequency to another."
