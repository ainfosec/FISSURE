...
class hd_tx_usrp_copy(gr.top_block):
    ...
    def __init__(self, artist="Test Artist", frequency="90.5e6", gain="70", title="Test Title", wav1_filepath="/home/user/FISSURE/Flow Graph Library/Single-Stage Flow Graphs/Attack Files/sample.wav", wav2_filepath="/home/user/FISSURE/Flow Graph Library/Single-Stage Flow Graphs/Attack Files/sample_mono.wav"):
        gr.top_block.__init__(self, "Hd Tx Usrp Copy", catch_exceptions=True)
...
def argument_parser():
    ...
    parser.add_argument(
        "--wav1-filepath", dest="wav1_filepath", type=str, default="/home/user/FISSURE/Flow Graph Library/Single-Stage Flow Graphs/Attack Files/sample.wav",
        help="Set wav1_filepath [default=%(default)r]")
    parser.add_argument(
        "--wav2-filepath", dest="wav2_filepath", type=str, default="/home/user/FISSURE/Flow Graph Library/Single-Stage Flow Graphs/Attack Files/sample_mono.wav",
