...
# Title: Rds Bpsk Usrpx310 File Source
# Generated: Sun Sep 19 09:44:44 2021
##################################################
...
class RDS_BPSK_USRPX310_File_Source(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Rds Bpsk Usrpx310 File Source")
        ...
        self.uhd_usrp_sink.set_gain(30, 0)
        ...
        self.fractional_resampler_xx_0_0_0 = filter.fractional_resampler_cc(0, (usrp_rate/10000)/100.0)
        self.fractional_resampler_xx_0_0 = filter.fractional_resampler_ff(0, 44.1/(usrp_rate/1000))
        self.fractional_resampler_xx_0 = filter.fractional_resampler_ff(0, 44.1/(usrp_rate/1000))
        ...
        self.connect((self.fractional_resampler_xx_0_0_0, 0), (self.uhd_usrp_sink, 0))
    ...
    def set_usrp_rate(self, usrp_rate):
        ...
        self.fractional_resampler_xx_0_0_0.set_resamp_ratio((self.usrp_rate/10000)/100.0)
        self.fractional_resampler_xx_0_0.set_resamp_ratio(44.1/(self.usrp_rate/1000))
        self.fractional_resampler_xx_0.set_resamp_ratio(44.1/(self.usrp_rate/1000))
    ...
    def set_tx_usrp_freq(self, tx_usrp_freq):
        ...
        self.uhd_usrp_sink.set_center_freq(self.tx_usrp_freq, 0)
...
def main(top_block_cls=RDS_BPSK_USRPX310_File_Source, options=None):
