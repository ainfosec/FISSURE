...
# Title: Mode S Ppm Usrpx310 File Sink
# Generated: Sun Sep 19 09:41:04 2021
##################################################
...
class Mode_S_PPM_USRPX310_File_Sink(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Mode S Ppm Usrpx310 File Sink")
...
def main(top_block_cls=Mode_S_PPM_USRPX310_File_Sink, options=None):
