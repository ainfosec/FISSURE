...
class TPMS_FSK_LimeSDR_Transmit(gr.top_block):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Tpms Fsk Limesdr Transmit", catch_exceptions=True)
        ...
        self.tx_frequency = tx_frequency = 314.96e6
        ...
        self.connect((self.blocks_stream_to_tagged_stream_0, 0), (self.limesdr_sink_0, 0))
