...
# Title: Simpliciti Msk Usrpx310 Add Node
# Generated: Sun Jan  9 14:10:51 2022
##################################################
...
class SimpliciTI_MSK_USRPX310_Add_Node(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Simpliciti Msk Usrpx310 Add Node")
        ...
        self.notes = notes = "Replays data from an add node message."
        self.ip_address = ip_address = "192.168.40.2"
        self.filepath = filepath = "/home/user/FISSURE/Flow Graph Library/Single-Stage Flow Graphs/Attack Files/SimpliciTI_Add_Node.bin"
...
def main(top_block_cls=SimpliciTI_MSK_USRPX310_Add_Node, options=None):
