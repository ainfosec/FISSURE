...
# Title: Mode S Ppm Rtl2832U Stdout
# Generated: Sun Sep 19 09:40:06 2021
##################################################
...
class Mode_S_PPM_RTL2832U_stdout(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Mode S Ppm Rtl2832U Stdout")
...
def main(top_block_cls=Mode_S_PPM_RTL2832U_stdout, options=None):
