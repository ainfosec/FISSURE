...
# Title: Simpliciti Fsk Limesdr Add Node
# Generated: Sun Jan  9 14:10:41 2022
##################################################
...
class SimpliciTI_FSK_LimeSDR_Add_Node(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Simpliciti Fsk Limesdr Add Node")
...
def main(top_block_cls=SimpliciTI_FSK_LimeSDR_Add_Node, options=None):
