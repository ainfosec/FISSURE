...
# Title: Zwave Fsk Usrpb210 Transmit
# Generated: Sat Jan  1 21:56:03 2022
##################################################
...
class ZWAVE_FSK_USRPB210_Transmit(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Zwave Fsk Usrpb210 Transmit")
...
def main(top_block_cls=ZWAVE_FSK_USRPB210_Transmit, options=None):
