...
# Title: Fm Radio Fm Usrpx310 Cw
# Generated: Sun Jan  9 15:07:09 2022
##################################################
...
class FM_Radio_FM_USRPX310_CW(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Fm Radio Fm Usrpx310 Cw")
        ...
        self.notes = notes = "Jams FM radio stations with a CW signal."
...
def main(top_block_cls=FM_Radio_FM_USRPX310_CW, options=None):
