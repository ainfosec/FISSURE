...
# Title: Rds Bpsk Usrpb210 File Source
...
class RDS_BPSK_USRPB210_File_Source(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Rds Bpsk Usrpb210 File Source", catch_exceptions=True)
        ...
        self.mmse_resampler_xx_2 = filter.mmse_resampler_cc(0, (usrp_rate/10000)/100.0)
        self.mmse_resampler_xx_1 = filter.mmse_resampler_ff(0, 44.1/(usrp_rate/1000))
        ...
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.mmse_resampler_xx_1, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_0_1, 0), (self.mmse_resampler_xx_0, 0))
        ...
        self.connect((self.gr_frequency_modulator_fc_0, 0), (self.mmse_resampler_xx_2, 0))
        ...
        self.connect((self.mmse_resampler_xx_0, 0), (self.gr_add_xx_0, 1))
        self.connect((self.mmse_resampler_xx_0, 0), (self.gr_sub_xx_0, 1))
        self.connect((self.mmse_resampler_xx_1, 0), (self.gr_add_xx_0, 0))
        self.connect((self.mmse_resampler_xx_1, 0), (self.gr_sub_xx_0, 0))
        self.connect((self.mmse_resampler_xx_2, 0), (self.uhd_usrp_sink_0, 0))
    ...
    def set_usrp_rate(self, usrp_rate):
        ...
        self.mmse_resampler_xx_1.set_resamp_ratio(44.1/(self.usrp_rate/1000))
        self.mmse_resampler_xx_2.set_resamp_ratio((self.usrp_rate/10000)/100.0)
...
def main(top_block_cls=RDS_BPSK_USRPB210_File_Source, options=None):
    tb = top_block_cls()
