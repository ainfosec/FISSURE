...
# Title: Mode S Ppm Usrpb205Mini File Sink
# Generated: Sat Jan  1 21:43:58 2022
##################################################
...
class Mode_S_PPM_USRPB205mini_File_Sink(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Mode S Ppm Usrpb205Mini File Sink")
...
def main(top_block_cls=Mode_S_PPM_USRPB205mini_File_Sink, options=None):
