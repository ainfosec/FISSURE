...
# Title: X10 Ook Usrpx310 X10 On
# Generated: Sun Sep 19 10:22:00 2021
##################################################
...
class X10_OOK_USRPX310_X10_On(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "X10 Ook Usrpx310 X10 On")
...
def main(top_block_cls=X10_OOK_USRPX310_X10_On, options=None):
