...
# Title: Zwave Fsk Limesdr Colorlist
# Generated: Sun Sep 19 10:27:39 2021
##################################################
...
class ZWAVE_FSK_LimeSDR_ColorList(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Zwave Fsk Limesdr Colorlist")
...
def main(top_block_cls=ZWAVE_FSK_LimeSDR_ColorList, options=None):
