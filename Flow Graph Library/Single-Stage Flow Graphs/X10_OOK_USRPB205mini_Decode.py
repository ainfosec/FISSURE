...
# Title: X10 Ook Usrpb205Mini Decode
# Generated: Sat Jan  1 21:50:49 2022
##################################################
...
class X10_OOK_USRPB205mini_Decode(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "X10 Ook Usrpb205Mini Decode")
...
def main(top_block_cls=X10_OOK_USRPB205mini_Decode, options=None):
