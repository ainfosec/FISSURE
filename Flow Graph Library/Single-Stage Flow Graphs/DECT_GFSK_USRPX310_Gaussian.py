...
# Title: Dect Gfsk Usrpx310 Gaussian
# Generated: Sun Jan  9 14:24:37 2022
##################################################
...
class DECT_GFSK_USRPX310_Gaussian(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Dect Gfsk Usrpx310 Gaussian")
        ...
        self.notes = notes = "Jams DECT with a Gaussian noise source."
...
def main(top_block_cls=DECT_GFSK_USRPX310_Gaussian, options=None):
