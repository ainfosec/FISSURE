...
# Title: Zwave Fsk Usrpb205Mini Off
# Generated: Sat Jan  1 21:52:43 2022
##################################################
...
class ZWAVE_FSK_USRPB205mini_Off(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Zwave Fsk Usrpb205Mini Off")
        ...
        self.notes = notes = "Transmits an off message for a Monoprice Z-Wave Plus RGB Smart Bulb."
...
def main(top_block_cls=ZWAVE_FSK_USRPB205mini_Off, options=None):
