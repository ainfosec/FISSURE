...
# Title: Zwave Fsk Usrpb210 Randomcolors
# Generated: Sat Jan  1 21:55:31 2022
##################################################
...
class ZWAVE_FSK_USRPB210_RandomColors(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Zwave Fsk Usrpb210 Randomcolors")
...
def main(top_block_cls=ZWAVE_FSK_USRPB210_RandomColors, options=None):
