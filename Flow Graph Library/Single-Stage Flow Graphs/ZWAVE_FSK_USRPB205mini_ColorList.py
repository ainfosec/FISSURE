...
# Title: Zwave Fsk Usrpb205Mini Colorlist
# Generated: Sat Jan  1 21:52:22 2022
##################################################
...
class ZWAVE_FSK_USRPB205mini_ColorList(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Zwave Fsk Usrpb205Mini Colorlist")
        ...
        self.notes = notes = "Cycles through a list of colors built into the message_generator_pdu block. Tested against a Monoprice Z-Wave Plus RGB Smart Bulb."
        ...
        # Blocks
        ##################################################
        self.zwave_poore_message_generator_pdu_0_0_0_0_0_0_0 = zwave_poore.message_generator_pdu(repetition_interval, 2, home_id, source_node_id, frame_control, destination_node_id, "33", "0505000001000240039c0400")
...
def main(top_block_cls=ZWAVE_FSK_USRPB205mini_ColorList, options=None):
